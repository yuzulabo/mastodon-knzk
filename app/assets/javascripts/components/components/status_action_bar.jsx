  ...
  render () {
    ...
    return (
      <div style={{ marginTop: '10px', overflow: 'hidden' }}>
        ...
        <div style={{ float: 'left', marginRight: '18px'}}><a href={"https://twitter.com/intent/tweet?text=" + encodeURIComponent(content_for_share)}><img src="/assets/twitter_icon.png"/></a></div>
